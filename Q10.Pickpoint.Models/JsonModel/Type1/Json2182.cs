...
public class Json2182 : JsonType1
{
    ...
    public class Properties
    {
        ...
        public string Restrictionsen { get; set; }
        public string ClarificationOfWorkingHoursen { get; set; }
        public string WebSiteen { get; set; }
        public string ExtraInfoen { get; set; }
        public int GlobalId { get; set; }
        public int ExtremeFormenisdeleted0 { get; set; }
        public string ExtremeFormenExtremeFormen0 { get; set; }
        public int ExtremeFormenGlobalId0 { get; set; }
        ...
        public int ExtremeFormenisdeleted1 { get; set; }
        public string ExtremeFormenExtremeFormen1 { get; set; }
        public int ExtremeFormenGlobalId1 { get; set; }
        public int Phoneenisdeleted2 { get; set; }
        public string PhoneenPhoneen2 { get; set; }
        public int PhoneenGlobalId2 { get; set; }
        public int ExtremeFormenisdeleted2 { get; set; }
        public string ExtremeFormenExtremeFormen2 { get; set; }
        public int ExtremeFormenGlobalId2 { get; set; }
        public int ExtremeFormenisdeleted3 { get; set; }
        public string ExtremeFormenExtremeFormen3 { get; set; }
        public int ExtremeFormenGlobalId3 { get; set; }
    }
