...
public class Json3082 : JsonType1
{
    public class Properties
    {
        ...
        public int PhoneDispatcherisdeleted0 { get; set; }
        public int PhoneDispatcherGlobalId0 { get; set; }
        public string PhoneDispatcherPhoneDispatcher0 { get; set; }
