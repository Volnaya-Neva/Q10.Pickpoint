...
public class Json1562 : JsonType1
{
    ...
    public class Properties
    {
        ...
        public int TerritoryisDeleted0 { get; set; }
        public string TerritoryTerritory0 { get; set; }
        public int TerritoryGlobalId0 { get; set; }
        public int TerritoryisDeleted1 { get; set; }
        public string TerritoryTerritory1 { get; set; }
        public int TerritoryGlobalId1 { get; set; }
        public int TerritoryisDeleted2 { get; set; }
        public string TerritoryTerritory2 { get; set; }
        public int TerritoryGlobalId2 { get; set; }
