...
public class Json1469 : JsonType1
{
    ...
    public class Properties
    {
        ...
        public int ExtremeFormisDeleted0 { get; set; }
        public string ExtremeFormExtremeForm0 { get; set; }
        public int ExtremeFormGlobalId0 { get; set; }
        ...
        public int ExtremeFormisDeleted1 { get; set; }
        public string ExtremeFormExtremeForm1 { get; set; }
        public int ExtremeFormGlobalId1 { get; set; }
        public int PhoneisDeleted2 { get; set; }
        public string PhonePhone2 { get; set; }
        public int PhoneGlobalId2 { get; set; }
        public int ExtremeFormisDeleted2 { get; set; }
        public string ExtremeFormExtremeForm2 { get; set; }
        public int ExtremeFormGlobalId2 { get; set; }
        public int ExtremeFormisDeleted3 { get; set; }
        public string ExtremeFormExtremeForm3 { get; set; }
        public int ExtremeFormGlobalId3 { get; set; }
    }
