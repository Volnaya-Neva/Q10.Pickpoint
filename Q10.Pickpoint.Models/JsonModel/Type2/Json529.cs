...
public class Json529 : JsonType2
{
    ...
    public class Properties
    {
        ...
        public float? ExpositionArea { get; set; }
        public int? TotalObjAmount { get; set; }
        public int? PaintingsAmount { get; set; }
        public int? GraphicsAmount { get; set; }
        public int? SculptureAmount { get; set; }
        public int? AppliedArtsAmount { get; set; }
        public int? NumismatObjAmount { get; set; }
        public int? ArchObjAmount { get; set; }
        public int? EthnoObjAmount { get; set; }
        public int? WeaponsObjAmount { get; set; }
        public int? RarePaperAmount { get; set; }
        public int? NatureObjAmount { get; set; }
        public int? TechHistoryObjAmount { get; set; }
        public int? OtherObjAmount { get; set; }
        public int? TotalPreciousObjAmount { get; set; }
